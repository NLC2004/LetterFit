...
LetterFit 从学院官网师资页整理老师名单，用大模型按对方研究方向改写你的自荐信——经历和奖项保持原文，模型只填写与老师相关的四个空位。**每一封都经你确认后，才从你自己的邮箱发出。**
...
| | |
|---|---|
| **精准而不群发** | 从师资页解析名单，你核对、勾选，只写给真正相关的老师 |
...
正常现象。把浏览器里的师资页全文复制，粘贴到「师资名单」页再解析即可。
</details>
